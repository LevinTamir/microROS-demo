...
// ---------- Wi-Fi + Agent ----------
char ssid[] = "TamirPhone";                // << replace with your WiFi SSID
char psk[]  = "22101995";           // << replace with your WiFi password
IPAddress agent_ip(172,20,10,2);   // << replace with your PC/agent IP
